...
require_once __DIR__ . '/WorkSubmission.php';
require_once __DIR__ . '/ContentBlock.php';
require_once __DIR__ . '/ContentBlockViews.php';
require_once __DIR__ . '/WorkSubmissionViews.php';
...
require_once __DIR__ . '/ProgressPdf.php';
