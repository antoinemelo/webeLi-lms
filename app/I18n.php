...
function js_i18n(): array
{
    return [
        ...
        'csv_export_objectives' => t('Exporter les objectifs en CSV'),
        'csv_export_skills' => t('Exporter les compétences en CSV'),
        'csv_import_skills' => t('Importer les compétences depuis un CSV'),
        'csv_export_rewards' => t('Exporter les encouragements en CSV'),
        'csv_import_rewards' => t('Importer les encouragements depuis un CSV'),
        'edit_skill' => t('Modifier cette compétence'),
        'edit_reward' => t('Modifier cet encouragement'),
