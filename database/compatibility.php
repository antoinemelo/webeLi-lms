...
return static function(PDO $pdo): void {
    $required=[
        ...
        'pathway_items'=>['id','course_id','page_id','position','access_mode','revision','is_evaluation','evaluation_weight'],
        'pathway_item_students'=>['pathway_item_id','student_id'],
        'progress'=>['id','enrollment_id','pathway_item_id','student_level','teacher_level','evaluation_score'],
