...
return static function(PDO $pdo): void {
    $required=[
        ...
        'pathway_items'=>['id','course_id','page_id','position','access_mode','framework_tracking_enabled','event_data','revision','is_evaluation','self_evaluation_enabled','evaluation_weight','created_at','updated_at'],
        ...
        'student_followup_participants'=>['followup_id','student_id'],
        'message_templates'=>['id','teacher_id','name','title','body','revision','updated_at'],
        'announcement_recipients'=>['announcement_id','student_id','student_name','title','body','email','cc'],
        'announcement_reads'=>['announcement_id','student_id','read_at'],
        'work_submissions'=>['student_id','pathway_item_id','page_block_id','url','body','status','revision','submitted_at'],
        'work_submission_versions'=>['id','student_id','pathway_item_id','page_block_id','url','body','prompt','title','submitted_at','reopened_at','reopened_by'],
        ...
        'notification_outbox'=>['cc','bcc','id','event','recipient','status','announcement_id','available_at'],
        'tags'=>['id','name','color'],
