...
return static function(PDO $pdo): void {
    $required=[
        ...
        'pathway_items'=>['id','course_id','page_id','position','access_mode','framework_tracking_enabled','revision','is_evaluation','self_evaluation_enabled','evaluation_weight','created_at','updated_at'],
