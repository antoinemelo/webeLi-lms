...
Le prototype couvre la bibliothèque de pages, les blocs, les tags, les QCM Markdown formatifs ou évaluatifs, les parcours par cours, les échéances, les évaluations, les objectifs, les compétences, la double validation 0–3, les rewards cumulés, les notifications différées et une interface mobile/PWA.
